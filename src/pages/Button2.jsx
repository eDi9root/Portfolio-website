...
const Button2 = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative overflow-hidden rounded-lg border-[1px] border-neutral-500 w-[150px] bg-[#00dc5cb6] mx-auto px-4 py-4 my-2 mt-10 font-bold text-black transition-colors hover:text-black"
    >
